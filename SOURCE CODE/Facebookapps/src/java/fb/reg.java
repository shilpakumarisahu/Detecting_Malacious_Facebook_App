        ...
        try {
            ...
            if (!isMultipart) {
                ...
                try {
                    ...
                    System.out.println("Images : " + items);
                ...
                while (itr.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        savedFile = new File("D:\\final project\\detecting malicious facebook applications\\SOURCE CODE\\Facebookapps\\web\\Profile//" + finalimage);
            ...
            strQuery = "insert into register(username,password,email,gender,country,phoneno,file)values('" + m.get(0) + "','" + m.get(1) + "','" + m.get(2) + "','" + m.get(3) + "','" + m.get(4) + "','" + m.get(5) + "','" + ms.get(0) + "')";
