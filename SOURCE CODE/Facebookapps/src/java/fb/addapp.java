 ...
 * @author Avancer Java
 */
@WebServlet(name = "addapp", urlPatterns = {"/addapp"})
...
String itemName = item.getName();
 ...
 System.out.println("7777777777777777");
                       ...
                       System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                        savedFile = new File("D:\\final project\\detecting malicious facebook applications\\SOURCE CODE\\Facebookapps\\web\\apps//" + finalimage);
                        item.write(savedFile);
                        System.out.println("/////--------/////");
//strQuery = "insert into app(username,appid,appname,accesstoken,appurl,status,appicon)values(" + m.get(0) + "','" + m.get(1) + "','" + m.get(2) + "','" + m.get(3) + "','" + m.get(4) + "','" + m.get(5) + "','" + ms.get(0) + "')";
     ...
     String strQuery ="";
         ...
         strQuery = "insert into app(username,appid,appname,appurl,status,appicon)values('" + m.get(0) + "','" + m.get(1) + "','" + m.get(2) + "','" + m.get(3) + "','" + m.get(4) + "','" + ms.get(0) + "')";
