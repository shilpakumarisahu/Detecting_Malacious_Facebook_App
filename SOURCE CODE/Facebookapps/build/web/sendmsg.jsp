  ...
  <div class="container">
	  <div class="about-main">
        ...
        <br><br>
                          ...
                          <button type="button" class="btn btn-1 btn-success"><a href="message.jsp">Send Message</a></button></li><br>
                            <br>
                             <button type="button" class="btn btn-1 btn-success"><a href="receivedmsg.jsp">View Received Message</a></button></li><br>
                            <br>
