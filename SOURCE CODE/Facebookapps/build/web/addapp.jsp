  ...
  <div class="container">
	  <div class="about-main">
        ...
        <br><br>
                            ...
                            <button type="button" class="btn btn-1 btn-success"><a href="addapplication.jsp">Develop Application to site</a></button></li><br>
                <br>                <button type="button" class="btn btn-1 btn-success"><a href="viewapp.jsp">View Applications</a></button></li><br>
                                <br><button type="button" class="btn btn-1 btn-success"><a href="myapp.jsp">View my developed Applications</a></button></li><br>
                <br><button type="button" class="btn btn-1 btn-success"><a href="myproapp.jsp">View my profile Applications</a></button></li><br>
