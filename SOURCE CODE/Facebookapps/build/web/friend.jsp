...
<center>                     <form id="loginForm">
        <br><br>
                           <button type="button" class="btn btn-1 btn-success"><a href="searchpage.jsp">Search friends</a></button></li><br>
            <br> <button type="button" class="btn btn-1 btn-success"><a href="frndlist.jsp">Friend List</a></button></li><br>
                <br> <button type="button" class="btn btn-1 btn-success"><a href="viewrequest.jsp">View Requests</a></button></li>
                <br><br>
    </form></center>
	  	</div>
