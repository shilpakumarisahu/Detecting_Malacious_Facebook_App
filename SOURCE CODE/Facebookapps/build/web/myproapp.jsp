	...
	<div class="container">
		<div class="gallery-main">
			<div class="gallery-top">
				<h3> My Profile Applications</h3>
				<p>The list of applications and games in my profile.</p>
			</div>
...
String Query = "Select * from proapp where username='"+username+"' ";
...
String appicon=rs.getString(7);
			   ...
			   <div class="col-md-4 view view-seventh">
                   ...
                   <br><br>
                    <span class="gall"> <a href="<%=appurl%>">Play</a></span>
